...
class MainWindow(QMainWindow):
    ...
    def update_inbox_selection(self, numbers):
        print(f"Original numbers: {numbers}")  # Debugging line
        formatted_numbers = [self.format_phone_number(num) for num in numbers]
        print(f"Formatted numbers: {formatted_numbers}")  # Debugging line
    ...
    def update_status_bar(self, message, timeout):
        ...
        # Set up a QTimer to display the next message after the initial message's timeout
        QTimer.singleShot(timeout, self.display_copyright_message)

    def display_copyright_message(self):
