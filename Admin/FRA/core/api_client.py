...
class ApiClient:
    ...
    # ---- Integrations: LibertyRx vendor basic auth (per reseller) ----
    def get_liberty_vendor_basic(self, reseller_id: str) -> Dict[str, Any]:
        """Fetch saved Liberty vendor Basic header (base64) for a reseller.
        Returns {} if not configured (404)."""
        url = f"{self.base_url}/admin/integrations/liberty/{reseller_id}/basic"
    ...
    def set_liberty_vendor_basic(self, reseller_id: str, basic_b64: str) -> bool:
        """Persist the computed Basic header value for a reseller."""
        url = f"{self.base_url}/admin/integrations/liberty/{reseller_id}/basic"
        payload = {"basic_b64": basic_b64}
    ...
    def clear_liberty_vendor_basic(self, reseller_id: str) -> bool:
        """Remove saved Basic header for a reseller if supported by FRAAPI."""
        url = f"{self.base_url}/admin/integrations/liberty/{reseller_id}/basic"
